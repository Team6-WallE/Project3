...
def generate_launch_description():
  ...
  urdf_model_name = 'my_robot.xacro'
  ...
  robot_localization_node = Node(
       ...
       output='screen',
       parameters=[os.path.join(get_package_share_directory('my_robot_description'), 'config/ekf.yaml'), {'use_sim_time': LaunchConfiguration('use_sim_time')}]
)
